...
public class BlogApiTest {
	...
	@Test
	public void postBlogUserShouldResponseWith409ConflictAfterDataIntegrityViolationException() throws Exception {
	...
	@Test
	public void postBlogUserShouldResponseWith404NotFoundAfterGetDataOfNonExistingUser() throws Exception {
		Long wrongId = 0L;
		when(finder.getUserData(wrongId)).thenThrow(EntityNotFoundException.class);

		mvc.perform(get("/blog/user/" + wrongId)
				.accept(MediaType.APPLICATION_JSON))
