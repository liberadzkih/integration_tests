...
public class BlogApiTest {
    ...
    @Test
    public void shouldThrowDataIntegrityViolationExceptionWhileCreatingWrongUser() throws Exception {
    ...
    @Test
    public void shouldReturn404WhenNoDataExist() throws Exception {
        Long notExistingID = 99L;
        when(finder.getUserData(notExistingID)).thenThrow(EntityNotFoundException.class);
        mvc.perform(get("/blog/user{id}", notExistingID))
