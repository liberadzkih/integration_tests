...
--insert into user (account_status, email, first_name, last_name) values ('CONFIRMED', 'Helena@domain.com', 'Helcia', 'Pomidor')
--insert into user (account_status, email, first_name, last_name) values ('NEW', 'Daniel@domain.com', 'Danielek', 'Jeleń')
